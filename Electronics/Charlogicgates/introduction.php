...
<div id="main" class="text"  style="position: absolute;left: 66px">
	This experiment includes characterization of TTL NAND gate.<br><br>
	This experiment enables a student to learn:
	<ul>
		<li>How to characterize different logic families</li>
<li>How to analyze logic operations of different logic families</li>
</ul>
	</div>
</div>
