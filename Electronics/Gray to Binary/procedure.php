...
<ol type="1">
	...
	<li>Consider a Gray code 0010 and input as G3=0, G2=0, G1=1, G0=0. Resulting output will be B3=0, B2=0, B1=1, B0=1. Hence, Gray code is now converted to Binary code!</li><br>
	<div align="center">
